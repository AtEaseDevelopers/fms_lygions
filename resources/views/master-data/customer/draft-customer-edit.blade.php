...
@section('title', 'Edit Draft Customer')
@section('content')
    <form action="{{ route('draft-customer.update', $draftCustomer->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="container mt-4">
            <div class="card">
                <div class="card-header">
                    <h4>Edit Draft Customer</h4>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="name" id="name" class="form-control"
                                    value="{{ old('name', $draftCustomer->name) }}">
                            </div>

                            <div class="form-group mb-3">
                                <label for="nickname">Nickname</label>
                                <input type="text" name="nickname" id="nickname" class="form-control"
                                    value="{{ old('nickname', $draftCustomer->nickname) }}">
                            </div>

                            <div class="form-group mb-3">
                                <label for="account_number">Account Number</label>
                                <input type="text" name="account_number" id="account_number" class="form-control"
                                    value="{{ old('account_number', $draftCustomer->account_number) }}">
                            </div>

                            <div class="form-group mb-3">
                                <label for="type">Type</label>
                                <select name="type" id="type" class="form-control">
                                    <option value="Consignor" {{ $draftCustomer->type == 'Consignor' ? 'selected' : '' }}>
                                        Consignor</option>
                                    <option value="Consignee" {{ $draftCustomer->type == 'Consignee' ? 'selected' : '' }}>
                                        Consignee</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="phone" id="phone" class="form-control"
                                    value="{{ old('phone', $draftCustomer->phone) }}">
                            </div>

                            <div class="form-group mb-3">
                                <label for="billing_phone">Billing Phone</label>
                                <input type="text" name="billing_phone" id="billing_phone" class="form-control"
                                    value="{{ old('billing_phone', $draftCustomer->billing_phone) }}">
                            </div>

                            <div class="form-group mb-3">
                                <label for="billing_address">Billing Address</label>
                                <textarea name="billing_address" id="billing_address" class="form-control" rows="3">{{ old('billing_address', $draftCustomer->billing_address) }}</textarea>
                            </div>

                            <div class="form-group mb-3">
                                <label for="email">Email</label>
                                <input type="text" name="email" id="email" class="form-control"
                                    value="{{ old('email', $draftCustomer->email) }}">
                            </div>

                            <div class="form-group mb-3">
                                <label for="website">Website</label>
                                <input type="text" name="website" id="website" class="form-control"
                                    value="{{ old('website', $draftCustomer->website) }}">
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="company_reg_no_new" id="company_reg_no_new" class="form-control"
                                    value="{{ old('company_reg_no_new', $draftCustomer->company_reg_no_new) }}">
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="company_reg_no_old" id="company_reg_no_old" class="form-control"
                                    value="{{ old('company_reg_no_old', $draftCustomer->company_reg_no_old) }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <textarea name="remark" id="remark" class="form-control" rows="3">{{ old('remark', $draftCustomer->remark) }}</textarea>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="consignor_currency" id="consignor_currency" class="form-control"
                                    value="{{ old('consignor_currency', $draftCustomer->consignor_currency) }}">
                            </div>

                            <div class="form-group mb-3">
                                <label for="consignee_currency">Consignee Currency</label>
                                <input type="text" name="consignee_currency" id="consignee_currency" class="form-control"
                                    value="{{ old('consignee_currency', $draftCustomer->consignee_currency) }}">
                            </div>

                            <div class="form-group mb-3">
                                <label for="city">City</label>
                                <input type="text" name="city" id="city" class="form-control"
                                    value="{{ old('city', $draftCustomer->city) }}">
                            </div>

                            <div class="form-group mb-3">
                                <label for="post_code">Post Code</label>
                                <input type="text" name="post_code" id="post_code" class="form-control"
                                    value="{{ old('post_code', $draftCustomer->post_code) }}">
                            </div>

                            <div class="form-group mb-3">
                                <label for="state">State</label>
                                <input type="text" name="state" id="state" class="form-control"
                                    value="{{ old('state', $draftCustomer->state) }}">
                            </div>

                            <div class="form-group mb-3">
                                <label for="country">Country</label>
                                <input type="text" name="country" id="country" class="form-control"
                                    value="{{ old('country', $draftCustomer->country) }}">
                            </div>

                            <div class="form-group mb-3">
                                <label for="tin">TIN</label>
                                <input type="text" name="tin" id="tin" class="form-control"
                                    value="{{ old('tin', $draftCustomer->tin) }}">
                            </div>

                            <div class="form-group mb-3">
                                <label for="service_tax_no">Service Tax No</label>
                                <input type="text" name="service_tax_no" id="service_tax_no" class="form-control"
                                    value="{{ old('service_tax_no', $draftCustomer->service_tax_no) }}">
                            </div>

                            <div class="form-group mb-3">
                                <label for="contact_person">Contact Person</label>
                                <input type="text" name="contact_person" id="contact_person" class="form-control"
                                    value="{{ old('contact_person', $draftCustomer->contact_person) }}">
                            </div>
            ...
            <!-- Draft Customer Locations Table -->
            <div class="card mt-4">
                <div class="card-header">
                    <h5>Draft Customer Locations</h5>
                ...
                <div class="card-body">
                    <table class="table table-hover align-middle" id="locationsTable">
                        ...
                        <tbody>
                            @foreach ($draftCustomer->locations as $location)
                                <tr>
                ...
                <div class="d-flex justify-content-end mt-3">
                    <a href="{{ route('draft-customer.index') }}" class="btn btn-secondary me-2">Cancel</a>
                    <button type="submit" class="btn btn-primary">Update Draft Customer</button>
                </div>
            </div>
        </div>
    </form>
